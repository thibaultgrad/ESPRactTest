...
SettingsDataStateService::SettingsDataStateService(AsyncWebServer* server,
    ...
    _httpEndpoint(SettingsDataState::read,
     ...
     _fsPersistence(SettingsDataState::read, SettingsDataState::update, this, &ESPFS, SAVED_DATAS_SETTINGS_FILE)
 {
