...
import { Typography, Box, Checkbox, TextField} from '@material-ui/core';
  ...
  return (
    <ValidatorForm onSubmit={saveData}>
      ...
      <BlockFormControlLabel
        ...
        label="LED State?"
      />
      <TextField id="standard-basic" label="Couleur" onChange={handleValueChange('led_color')} value={data.led_color} color="secondary" />
      <FormActions>
